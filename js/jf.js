...
$(function() {
	...
	$('#skill_list').append("<div class='skill-item col-sm-12'><h5 class='myhr-heading colour-fade-in-out col-sm-12'><span>Newer Skills<span></h5></div>");
	
	display_skills(new_skillset);

	$('#skill_list').append("<div class='skill-item col-sm-12'><h5 class='myhr-heading colour-fade-in-out col-sm-12'><span>Legacy Skills<span></h5></div>");
